...
export class NotificationController {
    ...
    public async getAllCtrl(req: Request, res: Response) {
        try {
            ...
            const notifications = await this.notificationUseCase.getNotifications(usr_uuid);
    ...
    public async getCtrl(req: Request, res: Response) {
        try {
            ...
            const notification = await this.notificationUseCase.findNotificationById(usr_uuid, ntf_uuid);
            return res.status(200).send({
                success: true,
    ...
    public async updateCtrl(req: Request, res: Response) {
        try {
            ...
            const notification = await this.notificationUseCase.updateNotification(usr_uuid, ntf_uuid, update);
            return res.status(200).json({
                success: true,
    ...
    public async deleteCtrl(req: Request, res: Response) {
        try {
            ...
            const notification = await this.notificationUseCase.deleteNotification(usr_uuid, ntf_uuid);
            return res.status(200).json({
                success: true,
